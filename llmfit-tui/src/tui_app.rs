...
use llmfit_core::providers::{self, ModelProvider, OllamaProvider, PullEvent, PullHandle};
...
impl App {
    ...
    fn re_sort(&mut self) {
        ...
        self.all_fits = llmfit_core::fit::rank_models_by_fit_opts(fits, self.installed_first);
        self.apply_filters();
    }
