...
MOE_ACTIVE_PARAMS = {
    ...
    "Qwen/Qwen3-Coder-30B-A3B-Instruct": 3_300_000_000,
...
def main():
    ...
    FALLBACKS = [
        ...
        },
        {
            ...
            "provider": "Alibaba", "parameter_count": "0.6B",
            "parameters_raw": 600000000,
            "min_ram_gb": 1.0, "recommended_ram_gb": 1.5, "min_vram_gb": 0.4,
            "quantization": "Q4_K_M", "context_length": 131072,
        ...
        },
        {
            ...
            "provider": "Alibaba", "parameter_count": "1.7B",
            "parameters_raw": 1700000000,
            "min_ram_gb": 1.0, "recommended_ram_gb": 2.0, "min_vram_gb": 0.9,
            "quantization": "Q4_K_M", "context_length": 131072,
            "use_case": "General purpose text generation",
            "pipeline_tag": "text-generation", "architecture": "qwen3",
            "hf_downloads": 0, "hf_likes": 0,
        ...
        {
            "name": "Qwen/Qwen3-4B",
            "provider": "Alibaba", "parameter_count": "4.0B",
            "parameters_raw": 4000000000,
            "min_ram_gb": 2.2, "recommended_ram_gb": 3.7, "min_vram_gb": 2.0,
            "quantization": "Q4_K_M", "context_length": 131072,
            "use_case": "General purpose text generation",
            "pipeline_tag": "text-generation", "architecture": "qwen3",
            "hf_downloads": 0, "hf_likes": 0,
        ...
        {
            "name": "Qwen/Qwen3-8B",
            "provider": "Alibaba", "parameter_count": "8.0B",
            "parameters_raw": 8000000000,
            "min_ram_gb": 4.5, "recommended_ram_gb": 7.4, "min_vram_gb": 4.1,
            "quantization": "Q4_K_M", "context_length": 131072,
            "use_case": "General purpose text generation",
            "pipeline_tag": "text-generation", "architecture": "qwen3",
            "hf_downloads": 0, "hf_likes": 0,
        ...
        {
            "name": "Qwen/Qwen3-32B",
            "provider": "Alibaba", "parameter_count": "32.8B",
        ...
        },
        {
            ...
            "provider": "Alibaba", "parameter_count": "30B (3B active)",
            "parameters_raw": 30000000000,
            "min_ram_gb": 17.0, "recommended_ram_gb": 24.0, "min_vram_gb": 16.0,
            "quantization": "Q4_K_M", "context_length": 131072,
            "use_case": "General purpose text generation",
            "pipeline_tag": "text-generation", "architecture": "qwen3_moe",
        ...
        },
        {
            ...
            "provider": "Alibaba", "parameter_count": "235B (22B active)",
            "parameters_raw": 235000000000,
            "min_ram_gb": 131.3, "recommended_ram_gb": 218.9, "min_vram_gb": 120.5,
            "quantization": "Q4_K_M", "context_length": 131072,
            "use_case": "General purpose text generation",
            "pipeline_tag": "text-generation", "architecture": "qwen3_moe",
            "is_moe": True, "num_experts": 128, "active_experts": 8,
        ...
        },
        {
            ...
            "provider": "Alibaba", "parameter_count": "480B (35B active)",
            "parameters_raw": 480000000000,
            "min_ram_gb": 268.2, "recommended_ram_gb": 447.0, "min_vram_gb": 246.2,
        ...
        },
        {
            ...
            "quantization": "Q4_K_M", "context_length": 131072,
            "use_case": "Multimodal, vision and text",
            "pipeline_tag": "image-text-to-text", "architecture": "qwen3_vl",
            "hf_downloads": 0, "hf_likes": 0,
        },
        {
            "name": "Qwen/Qwen3-VL-2B-Instruct",
            "provider": "Alibaba", "parameter_count": "2.5B",
            "parameters_raw": 2510000000,
            "min_ram_gb": 1.5, "recommended_ram_gb": 2.5, "min_vram_gb": 1.3,
            "quantization": "Q4_K_M", "context_length": 131072,
            "use_case": "Multimodal, vision and text",
            "pipeline_tag": "image-text-to-text", "architecture": "qwen3_vl",
            "hf_downloads": 0, "hf_likes": 0,
