...
MOE_ACTIVE_PARAMS = {
    ...
    "MiniMaxAI/MiniMax-M2": 18_200_000_000,
    "MiniMaxAI/MiniMax-M2.1": 18_200_000_000,
...
def main():
    ...
    FALLBACKS = [
        ...
        },
        {
            ...
            "provider": "MiniMax", "parameter_count": "228.7B",
            "parameters_raw": 228703644928,
            "min_ram_gb": 127.8, "recommended_ram_gb": 213.0, "min_vram_gb": 117.1,
            "quantization": "Q4_K_M", "context_length": 196608,
            "use_case": "General purpose, reasoning",
            "pipeline_tag": "text-generation", "architecture": "minimax_m2",
            "is_moe": True, "num_experts": 256, "active_experts": 8,
            "active_parameters": 18200000000,
            "hf_downloads": 0, "hf_likes": 0, "release_date": "2025-10-22",
        },
        {
            ...
            "is_moe": True, "num_experts": 256, "active_experts": 8,
            "active_parameters": 18200000000,
            "hf_downloads": 0, "hf_likes": 0, "release_date": "2025-12-20",
        },
        {
