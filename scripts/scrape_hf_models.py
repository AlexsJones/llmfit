...
TARGET_MODELS = [
    ...
    # GLM 4.7
    "ZhipuAI/GLM-4.7-0414",
    "ZhipuAI/GLM-4.7-Flash-0414",
    # MiniMax
...
def scrape_model(repo_id: str) -> dict | None:
    ...
    context_length = (
        infer_context_length(full_config)
        if full_config
